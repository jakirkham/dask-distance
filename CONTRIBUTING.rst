...
dask-distance could always use more documentation, whether as part of the
official dask-distance docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.7, 3.4, 3.5, and 3.6. Check
   https://travis-ci.org/jakirkham/dask-distance/pull_requests
