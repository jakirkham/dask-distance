...
The sources for dask-distance can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/jakirkham/dask-distance
.. _tarball: https://github.com/jakirkham/dask-distance/tarball/master
